...
{  
    ...
    public $productBrandCount;   
    public $productBrandCounts;   
    ...
    {  
        ...
        if ($id == 'all') {
            $this->product_brands = ProductBrand::query()
                ->with(['products.productCategoryFirst'],['products.productContent'])
                ->get(); 

            // $this->product_brands = ProductBrand::with([
            //     'products',
            //     ])
            //     ->findOrFail($this->id)->get()
            //     ->toArray();

            $this->productBrandCounts = $this->product_brands->count();
            ...
            $this->productBrandCount = $this->product_brands->count();
        }
    ...
    {  
        return view('livewire.pages.visitor.produk-brand-resources.produk-brand-list')  
