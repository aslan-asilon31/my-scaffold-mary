...
use App\Livewire\Pages\Admin\Contents\ProductBrandResources\Forms\ProductBrandForm;
use Livewire\Component;
use App\Models\EmployeeAccount;
use App\Models\ProductBrand;

class ProductBrandCrud extends Component
{
  public function render()
  {
    return view('livewire.pages.admin.contents.product-brand-resources.product-brand-crud')
      ->title($this->title);
  }
