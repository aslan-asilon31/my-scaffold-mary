...
class CategoryRecommendationCrud extends Component
{
  public function render()
  {
    return view('livewire.pages.admin.category-recommendation-resources.category-recommendation-crud')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  private string $baseFolderName = '/files/images/category-recommendations';

  #[\Livewire\Attributes\Locked]
  private string $baseImageName = 'category_recommendation_image';
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\CategoryRecommendation::class;

  public CategoryRecommendationForm $masterForm;
