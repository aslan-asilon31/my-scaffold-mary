...
use App\Livewire\Pages\Admin\Contents\ProductCategoryFirstResources\Forms\ProductCategoryFirstForm;
...
class ProductCategoryFirstCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.contents.product-category-first-resources.product-category-first-crud')
      ->title($this->title);
  }
