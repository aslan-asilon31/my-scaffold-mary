...
use App\Livewire\Pages\Admin\Generals\PermissionResources\Forms\PermissionForm;
use App\Models\Page;
...
class PermissionCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.generals.permission-resources.permission-crud')
      ->title($this->title);
  }
  ...
  protected $masterPositionPermissionModel = \App\Models\PositionPermission::class;
  ...
  public function edit()
  {
    ...
    $this->masterForm->permissions = $this->masterPositionPermissionModel::where('position_id', $this->id)
    ->pluck('permission_id')
    ->toArray();
  ...
  //     $this->masterPositionPermissionModel::where('position_id', $this->id)->delete();
  ...
  //     $this->masterPositionPermissionModel::insert($permissions);
