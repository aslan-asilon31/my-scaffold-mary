...
use App\Livewire\Pages\Admin\EmployeeResources\Forms\EmployeeForm;
...
class EmployeeCrud extends Component
{
  ...
  {
    return view('livewire.pages.admin.generals.employee-resources.employee-crud')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  private string $baseFolderName = '/files/images/employees';
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\Employee::class;

  public EmployeeForm $masterForm;
  ...
  public function store()
  {
    ...
    try {
      ...
      $validatedForm['position_id'] = $validatedForm['position_id'];
