<x-card :title="$title" shadow separator class="border shadow">
  ...
  <x-product-contents.product-content-tab activatedTab="product-content-review-images" :fieldId="$id" />
  ...
  <div class="overflow-x-auto rounded-lg border min-h-80">
    <table class="min-w-full border-gray-300">
      ...
      <tbody class="align-top">
        @forelse ($productContent['product_content_review_images'] as $index => $item)
